...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=NAMpanion Demo Installer\n"
      else:
        line="OutputBaseFilename=NAMpanion Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the NAMpanion Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the NAMpanion installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=NAMpanion Demo installer\n"
     else:
       line="SetupWindowTitle=NAMpanion installer\n"
